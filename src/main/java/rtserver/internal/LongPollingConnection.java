...
public class LongPollingConnection extends HttpConnection {
	...
	public LongPollingConnection(String id, ChannelHandlerContext writerContext) {
		this.id = id;
	...
	public ChannelFuture write() {
		...
		return this.requesterContext.getChannel().write(res);
	}
